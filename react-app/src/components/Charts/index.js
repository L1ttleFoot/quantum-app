...
export default function Chart (props) {
  ...
  const maxValue = newData.map(item=>parseFloat(parseFloat(item.energy).toPrecision(3))).reduce((a, b) => b > a ? b : a, 0)
  ...
  return (
    <ResponsiveContainer width="100%" height="100%">
      ...
      >
        ...
        <XAxis dataKey="energy" type='number' domain={[0, maxValue*1.1]}/>
